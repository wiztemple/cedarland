...
const Navbar = ({ menuList }) => {
  ...
  return (
    <>
      <nav
        aria-label="primary"
        className="w-full flex bg-white items-center justify-between flex-wrap px-5 dark:bg-gray-900 border border-white dark:border-gray-800 md:px-24 py-2 md:py-4 fixed shadow z-50"
      >
